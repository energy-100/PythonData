...
def printPath(level, pathtemp,name):
    ...
    sheet.write(0,6,"400-600")
    sheet.write(0,6,"latency[ms]")
    ...
    for fl in fileList:
        ...
        #print(allFileNum)
        filenum=filenum+1
    book.save(pathtemp+"JiaMei.xls")
    #book.save(pathtemp+"WangYing.xls")
if __name__ == '__main__':
    printPath(1, 'C:/Users/ENERGY/Desktop/',"T1-P2")
    print("1-done")
    printPath(1, 'C:/Users/ENERGY/Desktop/',"T2-P2")
    print("2-done")
    # printPath(1, 'C:/Users/ENERGY/Desktop/',"T1-400-1000")
    # print("1-done")
    # printPath(1, 'C:/Users/ENERGY/Desktop/',"T2-400-1000")
    # print("2-done")
    # printPath(1, 'C:/Users/ENERGY/Desktop/',"400-600(T2)")
    # print("2-done")
    # printPath(1, 'C:/Users/ENERGY/Desktop/',"600-800(T1)")
    # print("3-done")
    # printPath(1, 'C:/Users/ENERGY/Desktop/',"600-800(T2)")
    # print("4-done")
    # printPath(1, 'C:/Users/ENERGY/Desktop/',"800-1000(T1)")
    # print("5-done")
    # printPath(1, 'C:/Users/ENERGY/Desktop/',"800-1000(T2)")
    # print("6-done")